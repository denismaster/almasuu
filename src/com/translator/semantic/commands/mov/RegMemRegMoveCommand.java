...
public class RegMemRegMoveCommand implements Command {
    private String register1;
    private String register2;
    private boolean isWide;
    private ModeType mod;

    public RegMemRegMoveCommand(String register1, String register2, boolean isWide, ModeType mod) {
    ...
    public String generateCode(){
        String opCode = "1000111"+(this.isWide ? "1":"0");
